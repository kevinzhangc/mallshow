<template>
  ...
  <div v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;" v-if="!error">
    ...
    <div v-for="(item,i) in home" :key="i">
      ...
      <div class="activity-panel" v-if="item.panelContentItems[0].type === 1">
        <ul class="box">
      ...
      <section class="w mt30 clearfix" v-if="item.panelContentItems[0].type === 2">
      ...
      <section class="w mt30 clearfix" v-if="item.panelContentItems[0].type === 3">
        <y-shelf :title="item.name">
    ...
    mounted () {
      productHome().then(res => {
        ...
        for (let i = 0; i < data.length; i++) {
          if (data[i].panelContentItems[0].type === 0) {
